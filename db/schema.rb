...
ActiveRecord::Schema.define(version: 2023_10_11_135037) do
  ...
  create_table "collected_urls", force: :cascade do |t|
    t.string "url"
  ...
  create_table "features", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["category", "name"], name: "index_features_on_category_and_name", unique: true
  end
  ...
  create_table "kit_checks", force: :cascade do |t|
    t.integer "kit_id"
    t.string "check"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["check"], name: "index_kit_checks_on_check"
    t.index ["kit_id"], name: "index_kit_checks_on_kit_id"
  end
  ...
  create_table "node_lists", force: :cascade do |t|
    t.integer "class_def_id"
    t.string "name"
    t.text "children"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "xlass_defs", force: :cascade do |t|
    t.string "name"
  ...
  create_table "xnnotation_journals", force: :cascade do |t|
    t.json "json"
    t.integer "user_id"
    t.integer "task_id"
    t.integer "kit_id"
  ...
  create_table "xnnotations", force: :cascade do |t|
    t.integer "transaction_id"
    t.integer "parent_id"
    t.integer "user_id"
    t.integer "task_id"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["kit_id"], name: "index_xnnotations_on_kit_id"
    t.index ["node_value_id"], name: "index_xnnotations_on_node_value_id"
    t.index ["parent_id"], name: "index_xnnotations_on_parent_id"
    t.index ["task_id"], name: "index_xnnotations_on_task_id"
    t.index ["transaction_id"], name: "index_xnnotations_on_transaction_id"
    t.index ["tree_id"], name: "index_xnnotations_on_tree_id"
    t.index ["user_id"], name: "index_xnnotations_on_user_id"
  end

  create_table "xode_values", force: :cascade do |t|
    t.string "docid"
    t.integer "begi"
    t.integer "endi"
    t.text "value"
  ...
  create_table "xodes", force: :cascade do |t|
    t.string "name"
    t.integer "user_id"
    t.integer "task_id"
    t.integer "parent_id"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["node_value_id"], name: "index_xodes_on_node_value_id"
    t.index ["parent_id"], name: "index_xodes_on_parent_id"
    t.index ["parent_iid"], name: "index_xodes_on_parent_iid"
    t.index ["tree_id", "iid"], name: "index_xodes_on_tree_id_and_iid", unique: true
  end
