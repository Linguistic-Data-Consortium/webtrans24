<script>
    ...
    let btn_class = b == "DELETE" ? dbtn : cbtn;
    let btn_class2 = b == "DELETE" ? dbtn : "";
</script>
...
<details id={name} class="details-reset details-overlay details-overlay-dark">
    ...
    <details-dialog class="Box Box--overlay anim-fade-in fast">
        ...
        <div class="Box-footer text-right">
            ...
            {:else}
                <button type="button" class="{btn_class}"   data-close-dialog on:click={callf}>{b}</button>
