<script>
    ...
    export function set_active_transcript_line_to_last_created(){
        return segments.set_active_transcript_line_to_last_created();
    }
    let sections_open;
...
{#if sections_open}
    <Sections bind:this={sections} />
{/if}

<Segments bind:this={segments} {ns} {waveform} on:userf on:click_transcript_line />
